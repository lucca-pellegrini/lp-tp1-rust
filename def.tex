...
\usepackage{hyperref}
\hypersetup{pdfborderstyle={/S/U/W 0.5}} % Underline links (non-printing).
...
% Comando para simplificar links para a documentação padrão do Rust
	\newcommand{\stddoc}[2]{\href{https://doc.rust-lang.org/1.91.1/std/#1}{#2}}
