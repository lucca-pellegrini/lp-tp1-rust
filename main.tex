...
\author{ % Autores
	...
	\normalsize{\texttt{amanda.canizela@gmail.com}}
	\and
	\textsc{Ariel Inácio Jordão Coelho} \\
	\normalsize{\texttt{arielijordao@gmail.com}}
	\and
	\textsc{Lucca Pellegrini} \\
	\normalsize{\texttt{lucca@verticordia.com}}
}
...
\begin{abstract}
	...
	Rust\cite{klabnik2024rust}. Nele, será apresentada a história de tal
